...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'City.code'
        db.add_column(u'arriveontime_city', 'code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3),
                      keep_default=False)

        # Adding unique constraint on 'Airport', fields ['code']
        db.create_unique(u'arriveontime_airport', ['code'])

        # Adding unique constraint on 'Booking', fields ['reference']
        db.create_unique(u'arriveontime_booking', ['reference'])


    def backwards(self, orm):
        # Removing unique constraint on 'Booking', fields ['reference']
        db.delete_unique(u'arriveontime_booking', ['reference'])

        # Removing unique constraint on 'Airport', fields ['code']
        db.delete_unique(u'arriveontime_airport', ['code'])

        # Deleting field 'City.code'
        db.delete_column(u'arriveontime_city', 'code')
    ...
    models = {
        ...
        u'arriveontime.booking': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reference': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10'}),
